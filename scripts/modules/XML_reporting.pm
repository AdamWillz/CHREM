...
# ====================================================================
# primary_consumption
# Created by: Adam Wills, Carleton University
# Date: Apr 2015
# Based upon the GHG_conversion, this subroutine 
# writes out utility energy, quantity, and GHG from the xml log reporting
# and applies weighting factors to express them in terms of primary energy
# ====================================================================
#
#sub primary_consumption {
#	my $house_name = shift;
#	my $coordinates = shift;
#	
#	my $file = $house_name . '.xml';
...
#	
#
## Read in primary energy keys
#	my $prim_file;
#	if (-e '../../../keys/prim_key.xml') {$prim_file = '../../../keys/prim_key.xml'}
#	elsif (-e '../keys/prim_key.xml') {$prim_file = '../keys/prim_key.xml'}
#	my $PRIM = XMLin($prim_file);
#
#	# Remove the 'parameter' field
#	my $parameters = $XML->{'parameter'};
#	
