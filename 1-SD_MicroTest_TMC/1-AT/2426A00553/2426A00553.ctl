...
7
#DATA_LINE1 space seperated
7500 0 0 0 21 25 0 # heat_max_W heat_min_W cool_max_W cool_min_W heat_setpoint_C cool_setpoint_C relative_humidity?
#
...
1 0 0 0
# actuates flow component: bsmt-ft_wd
-4  2  1
#NUM_YEAR_PERIODS number of periods in year
1
#
...
bsmt-ft_wd   bsmt    bsmt-ft_wd
#
#AFN_TAG - THIS IS A MULTI-SENSOR CONTROLLER
* Control mass    2
# senses dry bulb temperature in main_1
1 0 0 0
# actuates flow component: bsmt-rt_wd
-4  3  1
#NUM_YEAR_PERIODS number of periods in year
1
#
