...
7395 0 0 0 21 100 0 # heat_max_W heat_min_W cool_max_W cool_min_W heat_setpoint_C cool_setpoint_C relative_humidity?
#
...
7
#DATA_LINE1 space seperated
7395 0 0 0 21 25 0 # heat_max_W heat_min_W cool_max_W cool_min_W heat_setpoint_C cool_setpoint_C relative_humidity?
#
...
7
#DATA_LINE1 space seperated
7395 0 0 0 0 25 0 # heat_max_W heat_min_W cool_max_W cool_min_W heat_setpoint_C cool_setpoint_C relative_humidity?
#
...
7
#DATA_LINE1 space seperated
6941 0 0 0 21 100 0 # heat_max_W heat_min_W cool_max_W cool_min_W heat_setpoint_C cool_setpoint_C relative_humidity?
#
#VALID_DAYS day # to day #; THIS IS SPRING WITH BOTH HEAT AND COOL
92 154
#NUM_DAY_PERIODS
...
7
#DATA_LINE1 space seperated
6941 0 0 0 21 25 0 # heat_max_W heat_min_W cool_max_W cool_min_W heat_setpoint_C cool_setpoint_C relative_humidity?
#
#VALID_DAYS day # to day #; THIS IS SUMMER COOLING
155 259
#NUM_DAY_PERIODS
...
7
#DATA_LINE1 space seperated
6941 0 0 0 0 25 0 # heat_max_W heat_min_W cool_max_W cool_min_W heat_setpoint_C cool_setpoint_C relative_humidity?
#
#VALID_DAYS day # to day #; THIS IS FALL WITH BOTH HEAT AND COOL
260 280
#NUM_DAY_PERIODS
...
#
#
#CTL_TAG - THIS IS A MASTER OR DISTRIBUTED CONTROLLER FOR ZONE 3
* Control function
#SENSOR_DATA four values - zero for in zone, first digit is zone num if sense in one zone only
3 0 0 0
#ACTUATOR_DATA three values - zero for in zone
...
7
#DATA_LINE1 space seperated
4164 0 0 0 21 100 0 # heat_max_W heat_min_W cool_max_W cool_min_W heat_setpoint_C cool_setpoint_C relative_humidity?
#
#VALID_DAYS day # to day #; THIS IS SPRING WITH BOTH HEAT AND COOL
92 154
#NUM_DAY_PERIODS
...
7
#DATA_LINE1 space seperated
4164 0 0 0 21 25 0 # heat_max_W heat_min_W cool_max_W cool_min_W heat_setpoint_C cool_setpoint_C relative_humidity?
#
#VALID_DAYS day # to day #; THIS IS SUMMER COOLING
155 259
#NUM_DAY_PERIODS
...
7
#DATA_LINE1 space seperated
4164 0 0 0 0 25 0 # heat_max_W heat_min_W cool_max_W cool_min_W heat_setpoint_C cool_setpoint_C relative_humidity?
#
#VALID_DAYS day # to day #; THIS IS FALL WITH BOTH HEAT AND COOL
260 280
#NUM_DAY_PERIODS
...
# senses dry bulb temperature in main_1
1 0 0 0
# actuates flow component: main_1-rt_wd
-4  4  1
#NUM_YEAR_PERIODS number of periods in year
1
#
...
#AFN_CTL_INPUTS, cooling_sensor_zone (zone for central cooling check) hot_setpoint (above this zone temp windows can operate) cold_setpoint(below this zone temp the windows are closed) DeltaT (if zone - ambient > deltaT windows can operate) minimum_ambient_temp (the minimum ambient temp which allows windows to open so as to prevent very cold air)
  1.0000 25.0000 21.0000 1.0000 21.0000
main_1-rt_wd   main_1    main_1-rt_wd
#
#AFN_TAG - THIS IS A MULTI-SENSOR CONTROLLER
* Control mass    3
# senses dry bulb temperature in main_1
...
# senses dry bulb temperature in main_1
1 0 0 0
# actuates flow component: main_2-ft_wd
-4  7  1
#NUM_YEAR_PERIODS number of periods in year
1
#
...
#AFN_CTL_INPUTS, cooling_sensor_zone (zone for central cooling check) hot_setpoint (above this zone temp windows can operate) cold_setpoint(below this zone temp the windows are closed) DeltaT (if zone - ambient > deltaT windows can operate) minimum_ambient_temp (the minimum ambient temp which allows windows to open so as to prevent very cold air)
  1.0000 25.0000 21.0000 1.0000 21.0000
main_2-ft_wd   main_2    main_2-ft_wd
#
#AFN_TAG - THIS IS A MULTI-SENSOR CONTROLLER
* Control mass    6
# senses dry bulb temperature in main_1
1 0 0 0
# actuates flow component: main_2-rt_wd
-4  8  1
#NUM_YEAR_PERIODS number of periods in year
1
#
...
#AFN_CTL_INPUTS, cooling_sensor_zone (zone for central cooling check) hot_setpoint (above this zone temp windows can operate) cold_setpoint(below this zone temp the windows are closed) DeltaT (if zone - ambient > deltaT windows can operate) minimum_ambient_temp (the minimum ambient temp which allows windows to open so as to prevent very cold air)
  1.0000 25.0000 21.0000 1.0000 21.0000
main_2-rt_wd   main_2    main_2-rt_wd
#
#AFN_TAG - THIS IS A MULTI-SENSOR CONTROLLER
* Control mass    7
# senses dry bulb temperature in main_1
1 0 0 0
# actuates flow component: main_2-bk_wd
-4  9  1
#NUM_YEAR_PERIODS number of periods in year
1
#
...
#AFN_CTL_INPUTS, cooling_sensor_zone (zone for central cooling check) hot_setpoint (above this zone temp windows can operate) cold_setpoint(below this zone temp the windows are closed) DeltaT (if zone - ambient > deltaT windows can operate) minimum_ambient_temp (the minimum ambient temp which allows windows to open so as to prevent very cold air)
  1.0000 25.0000 21.0000 1.0000 21.0000
main_2-bk_wd   main_2    main_2-bk_wd
#
#AFN_TAG - THIS IS A MULTI-SENSOR CONTROLLER
* Control mass    8
# senses dry bulb temperature in main_1
1 0 0 0
# actuates flow component: main_2-lt_wd
-4  10  1
#NUM_YEAR_PERIODS number of periods in year
1
#
...
#AFN_CTL_INPUTS, cooling_sensor_zone (zone for central cooling check) hot_setpoint (above this zone temp windows can operate) cold_setpoint(below this zone temp the windows are closed) DeltaT (if zone - ambient > deltaT windows can operate) minimum_ambient_temp (the minimum ambient temp which allows windows to open so as to prevent very cold air)
  1.0000 25.0000 21.0000 1.0000 21.0000
main_2-lt_wd   main_2    main_2-lt_wd
